...
describe('/authentications endpoint', () => {
  ...
  describe('when POST /authentications', () => {
    ...
    it('should response 400 if login payload is not string', async () => {
      // Arrange
      const requestPayload = {
        username: 'erudev',
        password: 1234,
  ...
  describe('when PUT /authentications', () => {
    ...
    it('should return 400 if refresh token not registered in database', async () => {
      ...
      const refreshToken = await container.getInstance(AuthenticationTokenManager.name)
        .createRefreshToken({ username: 'erudev' });
  ...
  describe('when DELETE /authentications', () => {
    ...
    it('should response 400 if refresh token is not registered in database', async () => {
      // Arrange
      const server = await createServer(container);
      const refreshToken = 'refresh_token';
